/**
 * changed version of https://github.com/FurqanSoftware/codemirror-languageserver/blob/c0f036fd0add6989f634664f3245cbb5eb8cdeca/src/index.ts
 */
...
import { Transport } from "../@open-rpc/client-js/transports/Transport";
...
export function languageServer(options: LanguageServerWebsocketOptions) {
  return languageServerWithTransport({
    ...options,
    transport: new WebSocketTransport(options.serverUri),
  });
}
